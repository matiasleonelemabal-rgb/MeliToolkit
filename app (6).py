...
def _agente_existe():
    return "agente_publicador_bytes" in st.session_state and st.session_state["agente_publicador_bytes"] is not None


def _leer_agente_ap():
    return st.session_state.get("agente_publicador_bytes")
